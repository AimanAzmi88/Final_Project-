...
const CreateSlot = ({ onFormSubmit }) => {
  ...
  return (
    <div className="fixed z-1 left-1/2 transform -translate-x-1/2 bottom-10 flex justify-center items-center min-h-screen w-2/3">
      <div className="max-w-lg w-full  bg-form p-6 shadow-bold">
